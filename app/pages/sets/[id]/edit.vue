  ...
  <div class="px-4 pt-8 pb-8 max-w-lg mx-auto overflow-x-hidden">
    ...
    <form v-else @submit.prevent="save" class="space-y-2.5">
      ...
      <div class="bg-white rounded-2xl p-5 border border-gray-100">
        <label class="text-sm text-gray-500 block mb-1.5">세트 이름</label>
        <input
          v-model="form.name"
          required
      ...
      <!-- 세트 색상 -->
      <div class="bg-white rounded-2xl p-5 border border-gray-100">
        <label class="text-sm text-gray-500 block mb-3">세트 색상</label>
      ...
      <!-- 책 선택 -->
      <div class="bg-white rounded-2xl p-5 border border-gray-100">
        <label class="text-sm text-gray-500 block mb-3">책 선택</label>
      ...
      <!-- 회독 횟수 -->
      <div class="bg-white rounded-2xl p-5 border border-gray-100">
        <label class="text-sm text-gray-500 block mb-1.5">회독 횟수</label>
        <input
      ...
      <!-- 기간 카드 -->
      <div class="bg-white rounded-2xl p-5 border border-gray-100">
        <label class="text-sm text-gray-500 block mb-3">기간</label>
      ...
      <!-- 쉬는 날 -->
      <div class="bg-white rounded-2xl p-5 border border-gray-100">
        <label class="text-sm text-gray-500 block mb-3">쉬는 날</label>
        <div class="flex gap-1.5">
          <button
